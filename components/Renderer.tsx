    ...
    <article className="my-10 ">
      <nav className="flex gap-4 gap-y-6 justify-between flex-wrap">
        <ul className="flex gap-2 flex-wrap print:opacity-50">
          {templates?.map((t, i) => (
            <li
              ...
              className="p-2 text-lg select-none font-bold border-t-4 border-primary shadow-lg bg-white hover:bg-primary hover:text-white transition-colors"
            >
              {t.label}
            </li>
          ))}
        ...
        <div className="ml-auto flex gap-2">
          <button
            ...
            onClick={handlePrint}
          >
         Print:   <FontAwesomeIcon icon={faPrint} className="text-xl" />
          </button>
        </div>
      </nav>
      <div className="bg-white print:hidden">
        ...
        <FrameConnector
          ...
          source={"https://deft-dango-261cf4.netlify.app/"}
