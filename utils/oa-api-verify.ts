...
const API_VERIFY_URL = "http://localhost:3000/dev/verify";
// "http://localhost:3000/dev/verify"
// "http://localhost:3000/dev/verify";
// "https://stg.api.verify.gov.sg/verify";
// "http://localhost:3000/dev/verify";
//  process.env.NEXT_PUBLIC_API_VERIFY_URL|| "https://stg.api.verify.gov.sg/verify";
